...
const themeStyles = {
  dark: {
    card: "bg-zinc-900 text-zinc-100 shadow-lg shadow-black/40",
    input: "bg-zinc-950 border border-zinc-800 text-zinc-100 focus:border-zinc-500",
    textBold: "text-zinc-100",
    textMuted: "text-zinc-400",
    buttonPrimary: "bg-[#0E3746] text-[#F4F2EC] hover:bg-[#065f47] shadow-[0_2px_8px_rgba(0,0,0,0.45)]",
    buttonSecondary: "bg-zinc-800 text-zinc-300 hover:bg-zinc-700 shadow-[0_1px_4px_rgba(0,0,0,0.45)]",
    badgeGreen: "bg-emerald-500/20 text-emerald-300 shadow-[0_1px_4px_rgba(0,0,0,0.40)]",
    badgeRed: "bg-rose-500/20 text-rose-300 shadow-[0_1px_4px_rgba(0,0,0,0.40)]",
    badgeYellow: "bg-amber-500/20 text-amber-300 shadow-[0_1px_4px_rgba(0,0,0,0.40)]",
    tabActive: "bg-[#0E3746] text-[#F4F2EC] shadow-[0_2px_8px_rgba(0,0,0,0.50)]",
    tabInactive: "text-zinc-400 hover:text-zinc-100",
  },
  light: {
    card: "bg-[#EAE8DC] text-[#0E3746] shadow-[0_2px_10px_rgba(14,55,70,0.10)]",
    input: "bg-[#F4F2EC] border border-[#0E3746]/20 text-[#0E3746] focus:border-[#0E3746]",
    textBold: "text-[#0E3746]",
    textMuted: "text-[#0E3746] opacity-80",
    buttonPrimary: "bg-[#0E3746] text-[#F4F2EC] hover:opacity-90 shadow-[0_2px_8px_rgba(14,55,70,0.30)]",
    buttonSecondary: "bg-[#EAE8DC] text-[#0E3746] hover:bg-[#F4F2EC] shadow-[0_1px_4px_rgba(14,55,70,0.12)]",
    badgeGreen: "bg-emerald-500/15 text-emerald-700 shadow-[0_1px_3px_rgba(14,55,70,0.10)]",
    badgeRed: "bg-rose-500/15 text-rose-600 shadow-[0_1px_3px_rgba(14,55,70,0.10)]",
    badgeYellow: "bg-amber-500/15 text-amber-700 shadow-[0_1px_3px_rgba(14,55,70,0.10)]",
    tabActive: "bg-[#0E3746] text-[#F4F2EC] shadow-[0_2px_8px_rgba(14,55,70,0.35)]",
    tabInactive: "text-[#0E3746] opacity-70 hover:opacity-100",
  },
};
